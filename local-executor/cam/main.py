...
class LocalExecutor(CsvLogging, Producer):
...
# ======================================================================
class LocalExecutor2(LocalExecutor):
    def __init__(self, consumer):
        self.producer_topic = 'result'
        super().__init__(consumer)

ARCHITECTURES = {
    "only_local": (LocalExecutorStorage, LocalExecutor1),
    "with_cloud": (LocalExecutorStorage, LocalExecutor2),
}
